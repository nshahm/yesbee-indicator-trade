  ...
  <div class="w-full lg:w-64 space-y-1">
    {#each tabs as tab}
      <button 
        ...
        class="w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-all {activeTab === tab ? 'bg-black/10 dark:bg-white/10 text-[#18181b] dark:text-white' : 'text-[#71717a] hover:text-[#18181b] dark:hover:text-[#a1a1aa] hover:bg-black/5 dark:hover:bg-white/5'}"
      >
        ...
        {#if activeTab === tab}
          <ChevronRight size={14} class="text-[#71717a] dark:text-[#a1a1aa]" />
        {/if}
      </button>
    {/each}
  </div>
  ...
  <div class="flex-1 max-w-2xl">
    <div class="rounded-xl border border-black/5 dark:border-white/5 bg-white dark:bg-[#0c0c0e] overflow-hidden">
      <div class="p-6 border-b border-black/5 dark:border-white/5 flex items-center justify-between">
        <h3 class="text-sm font-medium text-[#18181b] dark:text-white">{activeTab} Settings</h3>
      ...
      <div class="p-6 space-y-6">
          ...
          <div class="space-y-4">
            <div class="space-y-1.5">
              ...
              <input 
                ...
                class="w-full px-3 py-2 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg text-sm text-[#18181b] dark:text-white focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all"
              />
            </div>
            <div class="space-y-1.5">
              ...
              <input 
                ...
                type="password" 
                value="••••••••••••••••"
                class="w-full px-3 py-2 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg text-sm text-[#18181b] dark:text-white focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all font-mono"
              />
            </div>
          </div>
        {:else if activeTab === 'Risk Management'}
          <div class="space-y-4">
            <div class="flex items-center justify-between p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
              <div>
                <h4 class="text-sm font-medium text-[#18181b] dark:text-white">Auto Stop-Loss</h4>
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-1.5">
                ...
                <div class="relative">
                  ...
                  <input type="number" value="100000" class="w-full pl-7 pr-3 py-2 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg text-sm text-[#18181b] dark:text-white focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all" />
                </div>
              </div>
              <div class="space-y-1.5">
                <label class="text-[10px] uppercase font-bold text-[#71717a] tracking-wider">Max Risk %</label>
                <div class="relative">
                  <input type="number" value="1.0" class="w-full px-3 py-2 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg text-sm text-[#18181b] dark:text-white focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all" />
        ...
        {:else if activeTab === 'Indices'}
          <div class="space-y-4">
            {#each Object.entries(config) as [key, value]}
              <div class="flex items-center justify-between p-4 rounded-lg bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5 group hover:border-black/10 dark:hover:border-white/10 transition-all">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <h4 class="text-sm font-medium capitalize text-[#18181b] dark:text-white">{key}</h4>
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div class="w-10 h-5 {value.enabled ? 'bg-indigo-500' : 'bg-black/10 dark:bg-white/10'} rounded-full relative cursor-pointer transition-all">
        ...
        {:else}
          <div class="p-20 text-center">
            <Bell size={32} class="mx-auto text-black/5 dark:text-white/5 mb-4" />
